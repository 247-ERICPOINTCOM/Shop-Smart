    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            TopTitles(title: "Create Account", subtitle: "Delivery Sign Up"),
            SizedBox(
              height: 46.0,
            ),
            TextFormField(
            ...
            PrimaryButton(
              ...
              onPressed: () async {
                ...
                if (isValidated) {
                  bool isLoggedIn = await FirebaseAuthHelper.instance.signUpDelivery(
                      email.text,
                      username.text,
                      firstName.text,
                      lastName.text,
                      phone.text,
                      password.text,
                      userType.text = 'Delivery',
                      context);
                  if (isLoggedIn) {
                    Routes.instance.pushAndRemoveUntil(
                        widget: DeliveryPanel(), context: context);
                  }
                }
              },
            ),
