...
class BusinessOwnerSignUp extends StatefulWidget {
  ...
  @override
  State<BusinessOwnerSignUp> createState() => _CustomerSignUpState();
}

class _CustomerSignUpState extends State<BusinessOwnerSignUp> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            TopTitles(
                title: "Create Account", subtitle: "Business Owner Sign Up"),
            SizedBox(
              height: 46.0,
            ),
            TextFormField(
                ...
                if (isValidated) {
                  bool isLoggedIn = await FirebaseAuthHelper.instance
                      .signUpBusinessOwner(
                          ...
                          phone.text,
                          password.text,
                          userType.text = 'Business Owner',
                          context);
                  if (isLoggedIn) {
                    Routes.instance.pushAndRemoveUntil(
                        widget: Dashboard_BO(), context: context);
                  }
                }
              },
            ),
