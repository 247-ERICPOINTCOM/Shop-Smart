...
class _Add_UserState extends State<Add_User> {
          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButton <String>(
                ...
                items: status.map((buildMenuItemtype){
                  return DropdownMenuItem(
                    value: buildMenuItemtype,
                    child: Center(child: Text(buildMenuItemtype)),);
                }).toList(),
  ...
  DropdownMenuItem <String> buildMenuItemtype(String status) =>
      DropdownMenuItem(
        value: status,
        child: Text(status, style: const TextStyle(
            fontSize: 12.0,
